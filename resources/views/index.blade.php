                                        ...
                                        <div class="select-list">
                                            ...
                                            <div class="select-list-item">
                                                ...
                                                <select name="kapasitasmesin">
                                                    <option value="" data-display="Pilih Kapasitas Mesin">Pilih Kapasitas
                                                        Mesin</option>
                                        ...
                                        <div class="filter-price">
                                            ...
                                            <div class="price-input-row" style="margin-bottom: 25px;">
                                                <div class="price-input-item">
                                                    ...
                                                    <input type="number" name="min_price" id="rentMinPrice"
                                                        placeholder="Min" value="{{ $minPrice ?? 0 }}" min="0">
                                                </div>
                                                <div class="price-input-item">
                                                    <label>Harga Max:</label>
                                                    <input type="number" name="max_price" id="rentMaxPrice"
                                                        placeholder="Max" value="{{ $maxPrice ?? 1000000000 }}" min="0">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <form action="{{ route('cars') }}" method="GET" id="buyForm">
                                        ...
                                        <div class="filter-price" style="margin-bottom: 25px;">
                                            ...
                                            <div class="price-input-row">
                                                <div class="price-input-item">
                                                    <label>Harga Min:</label>
                                                    <input type="number" name="min_price" id="buyMinPrice" placeholder="Min"
                                                        value="{{ $minPrice ?? 0 }}" min="0">
                                                </div>
                                                <div class="price-input-item">
                                                    <label>Harga Max:</label>
                                                    <input type="number" name="max_price" id="buyMaxPrice" placeholder="Max"
                                                        value="{{ $maxPrice ?? 1000000000 }}" min="0">
                                                </div>
                                            </div>
                                        </div>
                                        <button type="submit" class="site-btn">Cari</button>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        ...
                        <p>Platform terpercaya untuk solusi kebutuhan otomotif Anda.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="services__item">
                        ...
                        <h5>Sewa Mobil</h5>
                        <p>Consectetur adipiscing elit incididunt ut labore et dolore magna aliqua. Risus commodo viverra
                            maecenas.</p>
                ...
                <div class="col-lg-4">
                    <div class="feature__text">
                        <div class="section-title">
                            ...
                            <h2>Nama Terpercaya di Dunia Otomotif</h2>
                        </div>
                        ...
                        <div class="feature__text__btn">
                            <a href="{{ route('about') }}" class="primary-btn">Tentang Kami</a>
                            <a href="{{ route('about') }}" class="primary-btn partner-btn">Mitra Kami</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row mb-5">
                <div class="col-lg-12">
                    <div class="text-center mb-4">
                        <span
                            style="display: inline-block; font-size: 14px; font-weight: 600; color: #df2d24; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 12px;">Koleksi
                            Mobil terbaru kami</span>
                        <h2 style="font-size: 42px; font-weight: 800; color: #1a1a1a; margin: 0; letter-spacing: -0.5px;">
                            Penawaran Terbaik</h2>
                        <p
                            style="font-size: 16px; color: #6b7280; margin-top: 12px; max-width: 600px; margin-left: auto; margin-right: auto;">
                            Temukan mobil impian Anda dari koleksi terpilih kami</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row car-filter">
                @forelse($cars->take(4) as $car)
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-4 mix{{ $car->tipe == 'buy' ? ' sale' : '' }}"
                        style="transition: opacity 0.3s ease, transform 0.3s ease, display 0.3s ease;">
                        <div class="car-card-modern"
                            style="background: #fff; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 12px rgba(0,0,0,0.08); transition: all 0.3s; height: 100%; display: flex; flex-direction: column;">
                            <!-- Car Image -->
                            <div class="car-image-wrapper"
                                style="position: relative; width: 100%; height: 220px; min-height: 220px; max-height: 220px; overflow: hidden; background: linear-gradient(135deg, #f5f7fa 0%, #e9ecef 100%);">
                                <div class="car__item__pic__slider owl-carousel"
                                    style="height: 220px; min-height: 220px; max-height: 220px; width: 100%;">
                                ...
                                <!-- Badge -->
                                <div
                                    style="position: absolute; top: 12px; left: 12px; background: {{ $car->tipe == 'buy' ? 'linear-gradient(135deg, #10b981, #34d399)' : 'linear-gradient(135deg, #3b82f6, #2563eb)' }}; color: #fff; padding: 6px 14px; border-radius: 6px; font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; box-shadow: 0 2px 8px rgba(0,0,0,0.2);">
                                    {{ $car->tipe == 'rent' ? 'Sewa' : 'Jual' }}
                                </div>
                                <!-- Year Badge -->
                                @if($car->tahun)
                                    <div
                                        style="position: absolute; top: 12px; right: 12px; background: rgba(0,0,0,0.7); color: #fff; padding: 6px 12px; border-radius: 6px; font-size: 12px; font-weight: 600; backdrop-filter: blur(10px);">
                                        {{ $car->tahun }}
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="car-info-content"
                                ...
                                <!-- Title -->
                                <h5
                                    style="margin: 0 0 12px 0; font-size: 18px; font-weight: 700; color: #1a1a1a; line-height: 1.4;">
                                    @auth
                                        <a href="{{ route('car.details', $car->uuid) }}"
                                            style="color: #1a1a1a; text-decoration: none; transition: color 0.3s;">{{ $car->brand ?? '' }}@if($car->nama)
                                            {{ $car->nama }}@endif</a>
                                    @else
                                        <a href="{{ route('login') }}"
                                            onclick="event.preventDefault(); if (typeof Swal !== 'undefined') { Swal.fire({icon: 'info', title: 'Login Diperlukan', text: 'Silakan login terlebih dahulu untuk melihat detail mobil', confirmButtonText: 'Login', confirmButtonColor: '#df2d24'}).then((result) => { if (result.isConfirmed) window.location.href='{{ route('login') }}'; }); } else { window.location.href='{{ route('login') }}'; } return false;"
                                            style="color: #1a1a1a; text-decoration: none; transition: color 0.3s;">{{ $car->brand ?? '' }}@if($car->nama)
                                            {{ $car->nama }}@endif</a>
                                    @endauth
                                </h5>
                                ...
                                <!-- Specs -->
                                <div class="car-specs"
                                    style="display: flex; gap: 16px; margin-bottom: 16px; padding-bottom: 16px; border-bottom: 1px solid #f3f4f6; flex-wrap: wrap;">
                                    <div style="display: flex; align-items: center; gap: 6px; font-size: 13px; color: #6b7280;">
                                        ...
                                        <span><strong
                                                style="color: #1a1a1a;">{{ number_format($car->kilometer ?? 0, 0, ',', '.') }}</strong>
                                            km</span>
                                    </div>
                                    <div style="display: flex; align-items: center; gap: 6px; font-size: 13px; color: #6b7280;">
                                    ...
                                    @if($car->bahan_bakar)
                                        <div style="display: flex; align-items: center; gap: 6px; font-size: 13px; color: #6b7280;">
                                            <i class="fas fa-gas-pump" style="color: #df2d24; font-size: 14px;"
                                                title="Bahan bakar"></i>
                                            <span style="color: #1a1a1a; font-weight: 600;">{{ $car->bahan_bakar }}</span>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="car-price" style="margin-top: auto;">
                                    <div style="font-size: 24px; font-weight: 800; color: #df2d24; line-height: 1.2;">
                                        ...
                                        @if($car->tipe == 'rent' && $car->metode)
                                            <span
                                                style="font-size: 14px; font-weight: 600; color: #6b7280;">/{{ $car->metode }}</span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                ...
                @empty
                    <div class="col-12">
                        <div class="text-center" style="padding: 80px 20px; background: #fff; border-radius: 12px;">
                            ...
                            <h4 style="font-size: 24px; font-weight: 700; color: #1a1a1a; margin-bottom: 12px;">Tidak ada mobil
                                tersedia</h4>
                            <p style="font-size: 16px; color: #6b7280; margin: 0;">Silakan tambahkan mobil melalui admin panel.
                            </p>
                        </div>
                    </div>
                @endforelse
                ...
                <div class="col-lg-5">
                    <div class="chooseus__text">
                        <div class="section-title">
                            ...
                            <p>Duis aute irure dolorin reprehenderits volupta velit dolore fugiat nulla pariatur excepteur
                                sint occaecat cupidatat.</p>
                        </div>
                        <ul>
                            <li><i class="fa fa-check-circle"></i> Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                            </li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <span>Blog Kami</span>
                        <h2>Pembaruan Berita Terbaru</h2>
                        <p>Dapatkan informasi terbaru seputar industri otomotif dan lainnya.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="latest__blog__item">
                            ...
                            style="background-image: url('{{ media_url($blog->image) }}');" @else
                                ...
                                <ul>
                                    ...
                                    <li>{{ $blog->published_at ? $blog->published_at->format('M d, Y') : $blog->created_at->format('M d, Y') }}
                                    </li>
                                    <li>{{ $blog->comment_count ?? 0 }} Komentar
                                    </li>
                                </ul>
                            </div>
                            <div class="latest__blog__item__text">
                                <h5>{{ $blog->title }}</h5>
                                <p>{{ $blog->excerpt ? Str::limit($blog->excerpt, 150) : Str::limit(strip_tags($blog->content), 150) }}
                                </p>
                                <a href="{{ route('blog.show', $blog->slug) }}">Lihat Selengkapnya <i
