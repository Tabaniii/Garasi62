            ...
            <div class="info-card animate-fade-in mb-4">
                ...
                <div class="card-body">
                    <div class="upload-section-modern">
                        ...
                        <input type="file" class="file-input-modern @error('images') is-invalid @enderror @error('images.*') is-invalid @enderror" id="images" name="images[]" accept="image/*" multiple required>
                        @error('images')
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="form-group-modern">
                                ...
                                <input type="text" class="form-control-modern @error('tahun') is-invalid @enderror" id="tahun" name="tahun" value="{{ old('tahun') }}" placeholder="2020" required maxlength="4" pattern="[0-9]{4}">
                                @error('tahun')
                                    <div class="error-message"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group-modern">
                                ...
                                <input type="text" class="form-control-modern @error('kilometer') is-invalid @enderror" id="kilometer" name="kilometer" value="{{ old('kilometer') }}" placeholder="50000" required maxlength="6" pattern="[0-9]+">
                                @error('kilometer')
                                    <div class="error-message"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="form-group-modern mt-3">
                        ...
                        <div class="input-group-modern">
                            ...
                            <input type="text" class="form-control-modern @error('harga') is-invalid @enderror" id="harga" name="harga" value="{{ old('harga') }}" placeholder="250000000" required maxlength="10" pattern="[0-9]+">
                        </div>
                        @error('harga')
                            <div class="error-message"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}</div>
                        @enderror
                    ...
                    <div class="row g-3 mt-2">
                        <div class="col-md-6">
                            <div class="form-group-modern">
                                ...
                                <div class="input-group-modern">
                                    <span class="input-prefix">Rp</span>
                                    <input type="text" class="form-control-modern @error('msrp') is-invalid @enderror" id="msrp" name="msrp" value="{{ old('msrp') }}" placeholder="120000000" maxlength="15" pattern="[0-9]+">
                                </div>
                                @error('msrp')
                                    <div class="error-message"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group-modern">
                                ...
                                <div class="input-group-modern">
                                    <span class="input-prefix">Rp</span>
                                    <input type="text" class="form-control-modern @error('dealer_discounts') is-invalid @enderror" id="dealer_discounts" name="dealer_discounts" value="{{ old('dealer_discounts') }}" placeholder="3000000" maxlength="15" pattern="[0-9]+">
                                </div>
