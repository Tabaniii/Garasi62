                ...
                <div class="row">
                        ...
                        <div class="cart-items">
                            ...
                            @foreach($carts as $cart)
                                <div class="cart-item mb-4"
                                    style="border: 1px solid #e8e8e8; border-radius: 5px; padding: 20px; background: #fff;">
                                    <div class="row align-items-center">
                                        <div class="col-md-3">
                                            ...
                                            @else
                                                <img src="{{ asset('garasi62/img/cars/car-8.jpg') }}" alt="No Image"
                                                    style="width: 100%; height: 150px; object-fit: cover; border-radius: 5px;">
                                            @endif
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <p class="text-muted mb-2">
                                                ...
                                                {{ number_format($cart->car->kilometer ?? 0, 0, ',', '.') }} km
                                            </p>
                                            <p class="mb-2">
                                                <span
                                                    class="badge {{ $cart->car->tipe == 'rent' ? 'badge-info' : 'badge-success' }}">
                                                    {{ $cart->car->tipe == 'rent' ? 'Disewakan' : 'Dijual' }}
                                                </span>
                                            </p>
                    ...
                    <div class="col-lg-4">
                        <div class="cart-summary"
                            style="border: 1px solid #e8e8e8; border-radius: 5px; padding: 20px; background: #fff; position: sticky; top: 20px;">
                            ...
                            <div class="summary-item mb-3" style="border-bottom: 1px solid #e8e8e8; padding-bottom: 15px;">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <strong style="font-size: 20px; color: #ff6b6b;">Rp
