        ...
        <div class="col-12">
            <div class="info-card animate-slide-in-right">
                ...
                <div class="d-grid gap-3" style="grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));">
                    <a href="{{ route('cars') }}" class="btn btn-danger btn-animate"
                    ...
                    <a href="{{ route('cars') }}?tipe=buy" class="btn btn-outline-success btn-animate"
                        style="padding: 12px 20px;">
                        <i class="fas fa-shopping-cart me-2"></i>Lihat Mobil Dijual
                    </a>
                    <a href="{{ route('cars') }}?tipe=rent" class="btn btn-outline-primary btn-animate"
                        style="padding: 12px 20px;">
                        <i class="fas fa-calendar-alt me-2"></i>Lihat Mobil Disewa
                    </a>
                    <a href="{{ route('reports.my-reports') }}" class="btn btn-outline-warning btn-animate"
                        style="padding: 12px 20px;">
                        <i class="fas fa-flag me-2"></i>Laporan Saya
                    </a>
                            ...
                            <div class="recent-car-card">
                                <div class="recent-car-image"
                                    ...
                                    <form action="{{ route('wishlist.destroy', $car->id) }}" method="POST"
                                        class="wishlist-remove-form" onclick="event.stopPropagation();">
                                        @csrf
                                        @method('DELETE')
                                ...
                                <div class="recent-car-info">
                                    <h6 class="recent-car-brand"
                                        onclick="window.location.href='{{ route('car.details', $car->uuid) }}'">
                                        {{ strtoupper($car->brand) }} {{ $car->nama }}</h6>
                                    <p class="recent-car-details">
                                        <i class="fas fa-calendar-alt"></i> {{ $car->tahun }} &nbsp;
                                        <i class="fas fa-tachometer-alt"></i> {{ number_format($car->kilometer, 0, ',', '.') }} km
                                        &nbsp;
                                    ...
                                    <div class="wishlist-actions">
                                        <a href="{{ route('car.details', $car->uuid) }}" class="btn btn-sm btn-danger">
