                    ...
                    <nav class="header__menu flex-grow-1 text-center">
                        <ul class="d-flex align-items-center justify-content-center list-unstyled mb-0">
                            <li class="mx-3"><a href="/"
                                    class="text-white text-uppercase text-decoration-none fw-normal {{ request()->routeIs('home') || request()->routeIs('index') ? 'active' : '' }}"
                                    style="{{ request()->routeIs('home') || request()->routeIs('index') ? 'border-bottom: 2px solid #dc3545; padding-bottom: 2px;' : '' }}">Beranda</a>
                            </li>
                            <li class="mx-3"><a href="/car"
                                    class="text-white text-uppercase text-decoration-none fw-normal {{ request()->routeIs('cars') ? 'active' : '' }}"
                                    style="{{ request()->routeIs('cars') ? 'border-bottom: 2px solid #dc3545; padding-bottom: 2px;' : '' }}">Mobil</a>
                            </li>
                            <li class="mx-3"><a href="/blog"
                                    class="text-white text-uppercase text-decoration-none fw-normal {{ request()->routeIs('blog') ? 'active' : '' }}"
                                    style="{{ request()->routeIs('blog') ? 'border-bottom: 2px solid #dc3545; padding-bottom: 2px;' : '' }}">Blog</a>
                            </li>
                            <li class="mx-3"><a href="/about"
                                    class="text-white text-uppercase text-decoration-none fw-normal {{ request()->routeIs('about') ? 'active' : '' }}"
                                    style="{{ request()->routeIs('about') ? 'border-bottom: 2px solid #dc3545; padding-bottom: 2px;' : '' }}">Tentang</a>
                            </li>
                            <li class="mx-3"><a href="/contact"
                                    class="text-white text-uppercase text-decoration-none fw-normal {{ request()->routeIs('contact') ? 'active' : '' }}"
                                    style="{{ request()->routeIs('contact') ? 'border-bottom: 2px solid #dc3545; padding-bottom: 2px;' : '' }}">Kontak</a>
                            </li>
                        </ul>
                    </nav>
                    <div class="header__nav__widget d-flex align-items-center" style="gap: 12px;">
                        <a href="#"
                            class="search-switch text-white text-decoration-none d-flex align-items-center justify-content-center"
                            style="width: 32px; height: 32px;"><i class="fa fa-search"></i></a>
                        @auth
                            <a href="{{ route('dashboard') }}" class="site-btn"
                                style="white-space: nowrap; text-decoration: none; border-radius: 5px;">Dashboard</a>
                            <form action="{{ route('logout') }}" method="POST" class="d-inline m-0">
                                @csrf
                                <button type="submit" class="site-btn"
                                    style="white-space: nowrap; text-decoration: none; border-radius: 5px;">Keluar</button>
                            </form>
                        @else
                            <a href="{{ route('login') }}" class="site-btn"
                                style="white-space: nowrap; text-decoration: none; border-radius: 5px;">Masuk</a>
                            <a href="{{ route('register') }}" class="site-btn"
                                style="white-space: nowrap; text-decoration: none; border-radius: 5px;">Daftar</a>
                        @endauth
                    </div>
                </div>
            </div>
