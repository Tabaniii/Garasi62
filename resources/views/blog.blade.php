                ...
                <div class="col-lg-10">
                    <div class="blog__details__hero__text">
                        ...
                        <ul>
                            ...
                            <li><i class="fa fa-comments"></i> <span>{{ $blog->comment_count }} Komentar</span></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8">
                                                ...
                                                <div class="col-lg-6">
                                                    <a href="{{ route('blog.show', $related->slug) }}"
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>{{ $related->published_at ? $related->published_at->format('M d, Y') : $related->created_at->format('M d, Y') }}
                                                            </li>
                                                        </ul>
                                                    </a>
                                                </div>
                    ...
                    <div class="blog__details__comment">
                        <h4>{{ $blog->comments->count() }} Komentar</h4>
                            ...
                            @foreach($blog->comments as $comment)
                                <div class="blog__details__comment__item" id="comment-{{ $comment->id }}">
                                    <div class="blog__details__comment__item__pic">
                                        <div
                                            style="width: 60px; height: 60px; border-radius: 50%; background: linear-gradient(135deg, #dc2626, #991b1b); display: flex; align-items: center; justify-content: center; color: #fff; font-weight: bold; font-size: 20px;">
                                    ...
                                    <div class="blog__details__comment__item__text">
                                        ...
                                        <p>{{ $comment->comment }}</p>
                                        <ul>
                                            <li><i class="fa fa-calendar-o"></i> {{ $comment->created_at->format('M d, Y H:i') }}
                                            </li>
                                            <li><a href="#" class="reply-btn" data-comment-id="{{ $comment->id }}"
                                                    data-commenter="{{ $comment->commenter_name }}"><i class="fa fa-reply"></i>
                                                    Balas</a></li>
                                        </ul>
                                    </div>
