                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('cars.update', $car->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label class="form-label small text-muted">Gambar yang ada:</label>
                                    <div id="existingImages" class="row g-2 mb-3">
                                        @foreach($car->image as $index => $imagePath)
                                        <div class="col-md-3 existing-image-item" data-image="{{ $imagePath }}">
                                            <div class="position-relative">
                                                <img src="{{ asset('storage/' . $imagePath) }}" alt="Gambar {{ $index + 1 }}" class="img-thumbnail w-100" style="height: 150px; object-fit: cover;">
                                                <button type="button" class="btn btn-sm btn-danger position-absolute top-0 end-0 m-1 remove-existing-image" data-image="{{ $imagePath }}">
                                ...
                                <label for="images" class="form-label small">Tambah Gambar Baru (Opsional):</label>
                                ...
                                @error('images.*')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">Pilih gambar baru untuk ditambahkan (Format: JPG, PNG, GIF, WEBP, Maks 5MB per gambar). Total gambar tidak boleh lebih dari 6.</small>
