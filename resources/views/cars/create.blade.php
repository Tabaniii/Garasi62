...
@section('header-title', 'Tambah Mobil Baru')
...
@section('content')
        ...
        <div class="page-header-content">
            <div class="page-header-text">
                ...
                <p class="page-subtitle">
                    <i class="fas fa-info-circle me-2"></i>Isi form di bawah ini untuk menambahkan mobil baru
                </p>
            </div>
                    ...
                    <div class="card-body">
                        <div class="upload-section-modern">
                            <label for="images" class="upload-label-modern">
                                ...
                                <span>Pilih Gambar Mobil <span class="text-danger">*</span></span>
                            </label>
                            <input type="file"
                            ...
                            <div class="col-md-4">
                                <div class="form-group-modern">
                                    ...
                                    <input type="text" class="form-control-modern @error('tahun') is-invalid @enderror"
                                        id="tahun" name="tahun" value="{{ old('tahun') }}" placeholder="2020" required
                            ...
                            <div class="col-md-4">
                                <div class="form-group-modern">
                                    ...
                                    <input type="text" class="form-control-modern @error('kilometer') is-invalid @enderror"
                                        id="kilometer" name="kilometer" value="{{ old('kilometer') }}" placeholder="50000"
                            ...
                            <div class="col-md-4">
                                <div class="form-group-modern">
                                    ...
                                    <input type="text"
                                        ...
                                        id="kapasitasmesin" name="kapasitasmesin" value="{{ old('kapasitasmesin') }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group-modern">
                                    ...
                                    <select class="form-control-modern @error('bahan_bakar') is-invalid @enderror"
                                        ...
                                        <option value="Bensin" {{ old('bahan_bakar') == 'Bensin' ? 'selected' : '' }}>Bensin
                                        </option>
                                        <option value="Solar" {{ old('bahan_bakar') == 'Solar' ? 'selected' : '' }}>Solar
                                        </option>
                                        <option value="Listrik" {{ old('bahan_bakar') == 'Listrik' ? 'selected' : '' }}>
                                            Listrik</option>
                                    </select>
                                    @error('bahan_bakar')
                                        <div class="error-message"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}
                            ...
                            <div class="col-md-4">
                                <div class="form-group-modern">
                                    ...
                                    <select class="form-control-modern @error('metode') is-invalid @enderror" id="metode"
                                        ...
                                        <option value="Kredit" {{ old('metode') == 'Kredit' ? 'selected' : '' }}>Kredit
                                        </option>
                                    </select>
                                    @error('metode')
                                        <div class="error-message"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}
                        ...
                        <div class="form-group-modern mt-3">
                            ...
                            <div class="input-group-modern">
                                ...
                                <input type="text" class="form-control-modern @error('harga') is-invalid @enderror"
                                    id="harga" name="harga" value="{{ old('harga') }}" placeholder="250000000" required
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    ...
                                    <input type="text" class="form-control-modern @error('stock') is-invalid @enderror"
                                        id="stock" name="stock" value="{{ old('stock') }}" placeholder="K99D10459934"
                                        maxlength="50">
                                    @error('stock')
                                        <div class="error-message"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    ...
                                    <input type="text" class="form-control-modern @error('vin') is-invalid @enderror"
                                        id="vin" name="vin" value="{{ old('vin') }}" placeholder="3VWKM245686"
                                        maxlength="50">
                                    @error('vin')
                                        <div class="error-message"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}
                                        </div>
                                ...
                                <div class="form-group-modern">
                                    ...
                                    <div class="input-group-modern">
                                        ...
                                        <input type="text" class="form-control-modern @error('msrp') is-invalid @enderror"
                                            id="msrp" name="msrp" value="{{ old('msrp') }}" placeholder="120000000"
                                ...
                                <div class="form-group-modern">
                                    ...
                                    <div class="input-group-modern">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('dealer_discounts') }}" placeholder="3000000" maxlength="15"
                                            pattern="[0-9]+">
                                    </div>
                        ...
                        <div class="form-group-modern mt-3">
                            ...
                            <textarea class="form-control-modern @error('description') is-invalid @enderror"
                                ...
                                placeholder="Masukkan deskripsi umum tentang mobil...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="error-message"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group-modern mt-3">
                            ...
                            <textarea class="form-control-modern @error('technical_specs') is-invalid @enderror"
                                ...
                                placeholder="Masukkan spesifikasi teknis mobil...">{{ old('technical_specs') }}</textarea>
    ...
    @push('scripts')
        <script>
            // Preview images before upload (support add/remove one-by-one)
            ...
            imagesInput.addEventListener('change', function (e) {
                ...
                if (newlySelected.length === 0) {
                    // User cancelled dialog; keep current selection
                    imagesInput.files = dt.files;
                    return;
                }
            ...
            document.addEventListener('click', function (e) {
                ...
                if (wrapper && (wrapper.classList.contains('preview-new') || wrapper.dataset.src)) {
