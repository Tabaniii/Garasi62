...
@section('content')
        ...
        <div class="col-lg-10 mx-auto">
            <form action="{{ route('cars.update', $car->id) }}" method="POST" enctype="multipart/form-data" id="carForm">
                ...
                <div class="info-card animate-fade-in mb-4">
                    ...
                    <div class="card-body">
                        <div class="form-group-modern">
                            ...
                            <select class="form-control-modern @error('tipe') is-invalid @enderror" id="tipe" name="tipe"
                                required>
                                <option value="">Pilih Tipe</option>
                                <option value="rent" {{ old('tipe', $car->tipe) == 'rent' ? 'selected' : '' }}>Rent (Sewa)
                                </option>
                                <option value="buy" {{ old('tipe', $car->tipe) == 'buy' ? 'selected' : '' }}>Buy (Beli)
                                </option>
                            </select>
                            @error('tipe')
                ...
                <div class="info-card animate-fade-in mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="upload-section-modern">
                            ...
                            <input type="file"
                                class="file-input-modern @error('images') is-invalid @enderror @error('images.*') is-invalid @enderror"
                                id="images" name="images[]" accept="image/*" multiple>
                            @error('images')
                                <div class="error-message mt-2"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}
                                </div>
                            @enderror
                            @error('images.*')
                                <div class="error-message mt-2"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content border-0 shadow-lg overflow-hidden" style="border-radius: 20px;">
                            <div class="modal-header border-0 pb-0 position-absolute w-100" style="z-index: 10;">
                                <button type="button" class="btn-close bg-white shadow-sm p-2 rounded-circle"
                                    data-bs-dismiss="modal" aria-label="Close" style="opacity: 0.8;"></button>
                            </div>
                            <div class="modal-body p-0 text-center bg-dark d-flex align-items-center justify-content-center"
                                style="min-height: 400px;">
                                <img id="modalPreviewImg" src="" alt="Preview"
                                    style="max-width: 100%; max-height: 80vh; object-fit: contain;">
                                <div id="modalImgInfo" class="position-absolute bottom-0 start-0 w-100 p-3 text-white"
                                    style="background: linear-gradient(transparent, rgba(0,0,0,0.8));"></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    ...
                                    <input type="text" class="form-control-modern @error('brand') is-invalid @enderror"
                                        id="brand" name="brand" value="{{ old('brand', $car->brand) }}"
                                        placeholder="Contoh: Toyota, Honda" required maxlength="20">
                                    @error('brand')
                                        <div class="error-message"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}
                                        </div>
                                    @enderror
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    ...
                                    <input type="text" class="form-control-modern @error('nama') is-invalid @enderror"
                                        id="nama" name="nama" value="{{ old('nama', $car->nama ?? '') }}"
                                        placeholder="Contoh: Avanza, Civic, Camry" required maxlength="100">
                                    @error('nama')
                                        <div class="error-message"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}
                                        </div>
                                    @enderror
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-4">
                                <div class="form-group-modern">
                                    ...
                                    <input type="text" class="form-control-modern @error('tahun') is-invalid @enderror"
                                        id="tahun" name="tahun" value="{{ old('tahun', $car->tahun) }}" placeholder="2020"
                            ...
                            <div class="col-md-4">
                                <div class="form-group-modern">
                                    ...
                                    <input type="text" class="form-control-modern @error('kilometer') is-invalid @enderror"
                                        id="kilometer" name="kilometer" value="{{ old('kilometer', $car->kilometer) }}"
                                        placeholder="50000" required maxlength="6" pattern="[0-9]+">
                                    @error('kilometer')
                                        <div class="error-message"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}
                                        </div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group-modern">
                                    ...
                                    <select class="form-control-modern @error('transmisi') is-invalid @enderror"
                                        id="transmisi" name="transmisi" required>
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-4">
                                <div class="form-group-modern">
                                    ...
                                    <input type="text"
                                        class="form-control-modern @error('kapasitasmesin') is-invalid @enderror"
                                        id="kapasitasmesin" name="kapasitasmesin"
                                        value="{{ old('kapasitasmesin', $car->kapasitasmesin) }}"
                                        placeholder="Contoh: 1500cc, 2000cc" required maxlength="50">
                            ...
                            <div class="col-md-4">
                                <div class="form-group-modern">
                                    <label for="bahan_bakar" class="form-label-modern">
                                        Bahan Bakar <span class="text-danger">*</span>
                                    </label>
                                    <select class="form-control-modern @error('bahan_bakar') is-invalid @enderror"
                                        id="bahan_bakar" name="bahan_bakar" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group-modern">
                                    ...
                                    <select class="form-control-modern @error('metode') is-invalid @enderror" id="metode"
                                        name="metode" required>
                                        <option value="">Pilih Metode</option>
                                        <option value="Cash" {{ old('metode', $car->metode) == 'Cash' ? 'selected' : '' }}>
                                            Cash</option>
                        ...
                        <div class="form-group-modern mt-3">
                            ...
                            <div class="input-group-modern">
                                ...
                                <input type="text" class="form-control-modern @error('harga') is-invalid @enderror"
                                    id="harga" name="harga" value="{{ old('harga', $car->harga) }}" placeholder="250000000"
                ...
                <div class="info-card animate-fade-in mb-4">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    <label for="stock" class="form-label-modern">Nomor Stok</label>
                                    <input type="text" class="form-control-modern @error('stock') is-invalid @enderror"
                                        id="stock" name="stock" value="{{ old('stock', $car->stock) }}"
                                        placeholder="K99D10459934" maxlength="50">
                                    @error('stock')
                                        <div class="error-message"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}
                                        </div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    <label for="vin" class="form-label-modern">Nomor VIN</label>
                                    <input type="text" class="form-control-modern @error('vin') is-invalid @enderror"
                                        id="vin" name="vin" value="{{ old('vin', $car->vin) }}" placeholder="3VWKM245686"
                                        maxlength="50">
                                    @error('vin')
                                        <div class="error-message"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}
                                        </div>
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    ...
                                    <div class="input-group-modern">
                                        <span class="input-prefix">Rp</span>
                                        <input type="text" class="form-control-modern @error('msrp') is-invalid @enderror"
                                            id="msrp" name="msrp" value="{{ old('msrp', $car->msrp) }}"
                                            placeholder="120000000" maxlength="15" pattern="[0-9]+">
                                    </div>
                                    @error('msrp')
                                        <div class="error-message"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    <label for="dealer_discounts" class="form-label-modern">Diskon Dealer</label>
                                    <div class="input-group-modern">
                                        <span class="input-prefix">Rp</span>
                                        <input type="text"
                                            class="form-control-modern @error('dealer_discounts') is-invalid @enderror"
                                            id="dealer_discounts" name="dealer_discounts"
                                            value="{{ old('dealer_discounts', $car->dealer_discounts) }}"
                                            placeholder="3000000" maxlength="15" pattern="[0-9]+">
                                    </div>
                        ...
                        <div class="form-group-modern mt-3">
                            ...
                            <textarea class="form-control-modern @error('description') is-invalid @enderror"
                                ...
                                placeholder="Masukkan deskripsi umum tentang mobil...">{{ old('description', $car->description) }}</textarea>
                            @error('description')
                                <div class="error-message"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group-modern mt-3">
                            ...
                            <input type="text" class="form-control-modern @error('location') is-invalid @enderror"
                                id="location" name="location" value="{{ old('location', $car->location) }}"
                                placeholder="Jakarta, Bandung, dll" maxlength="255">
                            @error('location')
                                <div class="error-message"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="info-card animate-fade-in mb-4">
                    <div class="info-card-header">
                        <h5 class="info-card-title">
                            <i class="fas fa-star me-2"></i>Fitur
                        </h5>
                        <span class="badge bg-secondary">Opsional</span>
                    </div>
                    <div class="card-body">
                        <div class="form-group-modern">
                            <label class="form-label-modern">Fitur Interior</label>
                            <div class="features-grid">
                                @php
                                    $interiorFeatures = old('interior_features', $car->interior_features ?? []);
                                    if (!is_array($interiorFeatures))
                                        $interiorFeatures = [];
                                @endphp
                                @for($i = 0; $i < 6; $i++)
                                    <input type="text" class="form-control-modern feature-input" name="interior_features[]"
                                        value="{{ $interiorFeatures[$i] ?? '' }}"
                                        placeholder="Fitur {{ $i + 1 }} (kosongkan jika tidak ada)">
                                @endfor
                            </div>
                        </div>

                        <div class="form-group-modern mt-3">
                            <label class="form-label-modern">Fitur Keamanan</label>
                            <div class="features-grid">
                                @php
                                    $safetyFeatures = old('safety_features', $car->safety_features ?? []);
                                    if (!is_array($safetyFeatures))
                                        $safetyFeatures = [];
                                @endphp
                                @for($i = 0; $i < 6; $i++)
                                    <input type="text" class="form-control-modern feature-input" name="safety_features[]"
                                        value="{{ $safetyFeatures[$i] ?? '' }}"
                                        placeholder="Fitur {{ $i + 1 }} (kosongkan jika tidak ada)">
                                @endfor
                            </div>
                        </div>
                        ...
                        <div class="form-group-modern mt-3">
                            <label class="form-label-modern">Fitur Ekstra</label>
                            <div class="features-grid">
                                @php
                                ...
                                @endphp
                                @for($i = 0; $i < 6; $i++)
                                    <input type="text" class="form-control-modern feature-input" name="extra_features[]"
                                        value="{{ $extraFeatures[$i] ?? '' }}"
                                        placeholder="Fitur {{ $i + 1 }} (kosongkan jika tidak ada)">
                                @endfor
                            </div>
                        </div>
                        ...
                        <div class="form-group-modern mt-3">
                            <label for="technical_specs" class="form-label-modern">Spesifikasi Teknis</label>
                            <textarea class="form-control-modern @error('technical_specs') is-invalid @enderror"
                                id="technical_specs" name="technical_specs" rows="5"
                                placeholder="Masukkan spesifikasi teknis mobil...">{{ old('technical_specs', $car->technical_specs) }}</textarea>
    ...
    <style>
        ...
        .image-wrapper-modern:hover::after {
            opacity: 1;
    ...
    @push('scripts')
        <script>
            ...
            function removeExistingImage(btn) {
                ...
                if (item) {
                    // Change hidden input name so backend knows this image was removed
                    const hiddenInput = item.querySelector('input[type="hidden"]');
                    if (hiddenInput) {
                        hiddenInput.name = 'removed_images[]';
                    }

                    // Add removed class (used by form validation) and hide
                    item.classList.add('removed');

                    // Check if all existing images are removed, hide the section label
                    const existingContainer = document.getElementById('existingImages');
                    if (existingContainer) {
                        const visibleItems = existingContainer.querySelectorAll('.existing-image-item:not(.removed)');
                        if (visibleItems.length === 0) {
                            const parentSection = existingContainer.closest('.mb-4');
                            if (parentSection) {
            ...
            function validateImageFile(file) {
                if (!allowedTypes.includes(file.type)) {
                    return `Format tidak didukung untuk "${file.name}". Gunakan JPG, PNG, GIF, atau WEBP.`;
                }
                if (file.size > maxSize) {
                    return `Ukuran file "${file.name}" terlalu besar. Maksimal 5MB per gambar.`;
                }
                return null;
            }

            function rebuildDataTransferWithoutIndex(removeIndex) {
                const next = new DataTransfer();
                for (let i = 0; i < dt.files.length; i++) {
                    if (i === removeIndex) continue;
                    next.items.add(dt.files[i]);
                }
                dt = next;
            ...
            function renderSelectedImages() {
                ...
                for (let i = 0; i < dt.files.length; i++) {
                    ...
                    item.innerHTML = `
                                                <div class="image-wrapper-modern preview-new" data-src="${objectUrl}" data-info="Baru: ${file.name} (${(file.size / 1024 / 1024).toFixed(2)} MB)">
                                                    <img src="${objectUrl}" alt="Preview ${i + 1}" class="image-preview-modern">
                                                    ...
                                                    <button type="button" class="btn-remove-image" data-remove-index="${i}" title="Hapus gambar">
                                                        <i class="fas fa-times"></i>
                                                    </button>
                                                </div>
                                            `;
            ...
            imagesInput.addEventListener('change', function (e) {
                const existingCount = document.querySelectorAll('.existing-image-item:not(.removed)').length;
                ...
                for (const file of newlySelected) {
                    ...
                    const totalIfAdded = existingCount + dt.files.length + 1;
                    if (totalIfAdded > maxTotal) {
                        const maxNew = Math.max(0, maxTotal - existingCount);
            ...
            preview.addEventListener('click', function (e) {
                ...
                rebuildDataTransferWithoutIndex(idx);
                renderSelectedImages();
            });
            ...
            function showLightbox(src, info) {
                const modal = getPreviewModal();
                if (!modal) return;

                document.getElementById('modalPreviewImg').src = src;
                document.getElementById('modalImgInfo').textContent = info;
                modal.show();
            }

            // Event Delegation for Preview Clicks
            document.addEventListener('click', function (e) {
                // Ignore if clicking remove button or its icon
                if (e.target.closest('.btn-remove-image') || e.target.closest('.btn-close')) {
                    return;
                }

                const wrapper = e.target.closest('.image-wrapper-modern');
                if (wrapper && (wrapper.classList.contains('preview-new') || wrapper.classList.contains('existing-image') || wrapper.dataset.src)) {
                    const src = wrapper.dataset.src;
                    const info = wrapper.dataset.info || 'Preview Gambar';
                    showLightbox(src, info);
                }
            });
